...
export const MyBacklogs = () => {
  ...
  const columns = [
    { header: 'Subject', cell: (row: Backlog) => row.subjectId?.subjectName || '-' },
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="shadow-sm border-slate-200">
              <CardContent className="p-6 text-center flex flex-col items-center justify-center h-full">
                <span className="text-slate-500 text-sm font-medium uppercase tracking-wider mb-2">Total Backlog History</span>
                <span className="text-4xl font-bold text-slate-800">{backlogs.length}</span>
              </CardContent>
            </Card>
            <Card className="shadow-sm border-slate-200">
              <CardContent className="p-6 text-center flex flex-col items-center justify-center h-full">
                <span className="text-slate-500 text-sm font-medium uppercase tracking-wider mb-2">Cleared Subjects</span>
                <span className="text-4xl font-bold text-emerald-600">{clearedBacklogs.length}</span>
              </CardContent>
            </Card>
            <Card className="shadow-sm border-slate-200">
              <CardContent className="p-6 text-center flex flex-col items-center justify-center h-full">
                <span className="text-slate-500 text-sm font-medium uppercase tracking-wider mb-2">Remaining Active Backlogs</span>
                <span className="text-4xl font-bold text-rose-600">{activeBacklogs.length}</span>
              </CardContent>
            </Card>
            <Card className={`shadow-sm border ${riskColor}`}>
              <CardContent className="p-6 flex flex-col items-center justify-center h-full text-center">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium uppercase tracking-wider opacity-80">Academic Risk</span>
                </div>
          ...
          {backlogs.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="shadow-sm border-slate-200">
                <CardHeader>
                  <CardTitle className="text-slate-800 text-base">Active vs Cleared</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="shadow-sm border-slate-200">
                <CardHeader>
                  <CardTitle className="text-slate-800 text-base">Backlogs by Semester</CardTitle>
                </CardHeader>
                <CardContent>
