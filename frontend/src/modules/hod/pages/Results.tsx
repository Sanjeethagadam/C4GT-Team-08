      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
           <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 text-center text-slate-500">
             ...
             <p>Official university results will appear here once parsed and verified from the JNTUK source.</p>
           </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
               <ChartCard title="Historical Pass Rate Trend" description="Overall pass percentage across all available semesters">
                 {trend.length <= 1 ? (
                    <div className="flex h-full items-center justify-center text-slate-500 text-sm">Historical trend will appear after results are available for multiple semesters.</div>
                 ) : (
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={trend} margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
                      <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#e2e8f0" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <ChartCard title="Grade Distribution" description="Grades obtained in this semester">
              {sortedGradeDistribution.length === 0 ? (
                 <div className="flex h-full items-center justify-center text-slate-500">Grade details unavailable.</div>
              ) : (
                <ResponsiveContainer width="100%" height={350}>
