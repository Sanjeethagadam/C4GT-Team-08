        ...
        <div className="space-y-6">
            ...
            <div className="lg:col-span-2">
              <ChartCard title="Backlogs by Semester (Active vs Cleared)" description="Trend of backlogs generated per semester and their current clearance status">
                {semesterDist.length === 0 ? (
                  <div className="flex h-full items-center justify-center text-slate-500">No historical backlog data available</div>
                ) : (
                ...
                {statusDist.length === 0 || totalEver === 0 ? (
                  ...
                  <ResponsiveContainer width="100%" height={350}>
                    <PieChart>
                      ...
                      <text x="50%" y="50%" textAnchor="middle" dominantBaseline="middle" className="font-semibold text-xl fill-slate-700">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <ChartCard title="Active Backlogs by Branch" description="Currently active backlogs distributed by branch">
              {branchDist.length === 0 ? (
                <div className="flex h-full items-center justify-center text-slate-500">No active backlogs</div>
              ) : (
                <ResponsiveContainer width="100%" height={350}>
