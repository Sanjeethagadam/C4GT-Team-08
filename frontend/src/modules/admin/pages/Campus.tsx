...
export const Campus = () => {
  ...
  const [campusToDelete, setCampusToDelete] = useState<CampusType | null>(null);
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      setError(err.message || 'Failed to delete campus. It may be referenced by other records.');
      setIsDeleteDialogOpen(false);
    } finally {
      setIsDeleting(false);
    }
