...
export const CtpoDashboard = () => {
  ...
  const riskPieData = [
    { name: 'Low Risk (0-1)', value: metrics.riskDistribution.low, color: COLORS.LOW },
    { name: 'Medium Risk (2-4)', value: metrics.riskDistribution.medium, color: COLORS.MEDIUM },
    { name: 'High Risk (5+)', value: metrics.riskDistribution.high, color: COLORS.HIGH },
  ].filter(d => d.value > 0);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div onClick={() => navigate('/ctpo/students')} className="cursor-pointer transition-transform hover:scale-[1.02]">
          <StatCard 
        ...
        <div onClick={() => navigate('/ctpo/students?backlog=WITH')} className="cursor-pointer transition-transform hover:scale-[1.02]">
          <StatCard 
        ...
        />
        <div onClick={() => navigate('/ctpo/students?risk=AT-RISK')} className="cursor-pointer transition-transform hover:scale-[1.02]">
          <StatCard 
        ...
        <Card>
          ...
          <CardContent>
            {riskPieData.length === 0 ? (
              <div className="h-64 flex items-center justify-center text-slate-500">No risk data available</div>
            ) : (
              <div className="h-64">
