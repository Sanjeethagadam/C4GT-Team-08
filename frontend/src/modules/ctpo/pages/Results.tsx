                ...
                return (
                  <React.Fragment key={student._id}>
                    ...
                    >
                      ...
                      <TableCell className="font-medium text-slate-800">{student.rollNo}</TableCell>
                            ...
                            <Table className="bg-white border rounded-md overflow-hidden shadow-sm">
                              <TableHeader className="bg-slate-100">
                                <TableRow>
                                  ...
                                  <TableHead className="py-2">Grade Point</TableHead>
                                  <TableHead className="py-2">Credits</TableHead>
                              ...
                              <TableBody>
                                {studentResults.map((r) => (
                                  <TableRow key={r._id}>
                                    <TableCell className="py-2">{r.subjectId?.subjectName}</TableCell>
                                    <TableCell className="py-2 font-medium">{r.grade || '-'}</TableCell>
                                    <TableCell className="py-2">{r.gradePoint !== undefined && r.gradePoint !== null ? r.gradePoint : '-'}</TableCell>
                                    <TableCell className="py-2">{r.credits !== undefined ? r.credits : '-'}</TableCell>
